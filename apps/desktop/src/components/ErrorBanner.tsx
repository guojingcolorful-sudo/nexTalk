 ...
 * 4px border, optional 重试. It sits above the affected region and never
 * replaces it, so the user keeps the context they were looking at.
 *
 * role="alert" announces the failure to assistive tech without moving focus.
 */
